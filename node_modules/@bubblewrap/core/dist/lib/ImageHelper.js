...
class ImageHelper {
    ...
    async monochromeFilter(icon, themeColor) {
        ...
        image.color([
            ...
            { apply: plugin_color_1.ColorActionName.RED, params: [-255] },
            { apply: plugin_color_1.ColorActionName.GREEN, params: [-255] },
            { apply: plugin_color_1.ColorActionName.BLUE, params: [-255] },
            // Add to channels using theme color
            { apply: plugin_color_1.ColorActionName.RED, params: [themeColor.red()] },
            { apply: plugin_color_1.ColorActionName.GREEN, params: [themeColor.green()] },
            { apply: plugin_color_1.ColorActionName.BLUE, params: [themeColor.blue()] },
        ]);
    ...
    async fetchIcon(iconUrl) {
        ...
        if (contentType.startsWith('image/svg')) {
            ...
            try {
                body = await (0, svg2img_1.svg2img)(textDecoder.decode(body));
            }
            catch (error) {
